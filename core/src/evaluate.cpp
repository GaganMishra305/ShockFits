// NOTE: <bits/stdc++.h> is a GCC-only, non-standard header and does not exist
// on Apple clang / MSVC. Include exactly what we use (portable + faster builds).
#include <cctype>
#include <string>
...
unordered_map<string, vector<vector<int>>> pst_w = { // piece square table
    {"p",{
